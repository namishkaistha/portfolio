  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center p-8 bg-background text-foreground space-y-8">
      ...
      <ProjectCard
        ...
        category={["Full Stack", "Project Manager"]}
      ...
      <ProjectCard
        ...
        category={["Project Manager", "Full Stack", "ML"]}
      />
      <ProjectCard
        title="Stock Picker"
        tech={["Python", "Flask", "Finbert", "Goose3"]}
        description="Trading program that gives users actionable insights on stocks"
        accomplishments={[
      ...
      <ProjectCard
        ...
        description="Multimodal AI meeting assistant developed at Northwestern's C3 Lab"
        accomplishments={[
