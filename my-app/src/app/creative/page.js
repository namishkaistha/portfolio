    ...
    return(
      <main className ="min-h-screen bg-white dark:bg-black flex flex-col items-center gap-8 p-8">
        <h2 className="text-3xl p-8 dark:text-white">Project Alchemy</h2>
          <div>
            <IntroCard photo={ProjectAlchemy}
            description={
              <div className="text-center md:text-left">
                <p className = "text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  ...
                  <a 
                    ...
                    Project Alchemy Podcast </a>
                  was mine and Jack Considine's excuse to learn
                  from Entrepreneurs and Creatives that we wanted to emulate. Along the way, 
                  we recorded over 200 episodes, and crystallized our mission: to empower young people 
                  to pursue the "unconventional" path. Below, click on some of our most interesting
                  interviews to find my favorite quotes and insights. 
                  </p>
              </div>
            }/>
