...
export default function PodCard({ title, description, link }) {
  ...
  return (
    ...
    `}
      >
        <div className="absolute inset-0 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center [backface-visibility:hidden]">
